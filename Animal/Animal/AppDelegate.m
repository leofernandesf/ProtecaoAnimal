...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
    NSLog(@"testando essa aplicacao tambem");
    return [[FBSDKApplicationDelegate sharedInstance] application:application
                                                          openURL:url
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    NSLog(@"testando essa aplicacao em background");
...
- (void)applicationWillEnterForeground:(UIApplication *)application {
    ...
    NSLog(@"testando essa aplicacao bacgorund 2");
}

- (void)applicationDidBecomeActive:(UIApplication *)application {
    NSLog(@"testando essa aplicacao tambem 2 ");
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "br.com..Animal" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Animal" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Animal.sqlite"];
    NSError *error = nil;
